...
<mach-ii version="1.9">
	...
	<event-handlers>
		...
		<event-handler event="proposals" access="public">
			...
			<notify listener="proposalListener" method="getUserVotes" resultArg="userVotes" />
			<view-page name="proposals" contentArg="content" />
			<execute subroutine="template.main" />
		</event-handler>
		
		<event-handler event="voteForProposal" access="public">
		...
		<event-handler event="proposalFavorites" access="public">
			<event-arg name="includeTableSorter" value="true" />
			<notify listener="proposalListener" method="getProposalFavorites" resultArg="proposals" />
			<notify listener="proposalListener" method="getUserVotes" resultArg="userVotes" />
			<view-page name="proposals" contentArg="content" />
			<execute subroutine="template.main" />
		</event-handler>
		...
		<event-handler event="topicSuggestions" access="public">
			...
			<view-page name="topicSuggestions" contentArg="content" />
			<execute subroutine="template.main" />
		</event-handler>
		...
		<event-handler event="topicSuggestionForm" access="public">
			...
			<!-- <call-method bean="categoryService" method="getCategories" args="${event.eventID}" resultArg="categories" /> -->
