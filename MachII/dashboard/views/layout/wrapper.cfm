...
<head>
	...
	<view:style endpoint="dashboard.serveAsset" p:file="/css/combined.cfm:css" media="screen,projection" outputType="inline" />
...
<cfif event.isArgDefined("meta.refresh")>
	...
	<view:script endpoint="dashboard.serveAsset" p:file="/js/libraries.js" outputType="inline" />
